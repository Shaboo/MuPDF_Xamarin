...
namespace Artifex.MuPdf {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']"
	[global::Android.Runtime.Register ("com/artifex/mupdfdemo/OutlineAdapter", DoNotGenerateAcw=true)]
	public partial class OutlineAdapter : global::Android.Widget.BaseAdapter {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/artifex/mupdfdemo/OutlineAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (OutlineAdapter); }
		}

		protected OutlineAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_view_LayoutInflater_arrayLcom_artifex_mupdfdemo_OutlineItem_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']/constructor[@name='OutlineAdapter' and count(parameter)=2 and parameter[1][@type='android.view.LayoutInflater'] and parameter[2][@type='com.artifex.mupdfdemo.OutlineItem[]']]"
		[Register (".ctor", "(Landroid/view/LayoutInflater;[Lcom/artifex/mupdfdemo/OutlineItem;)V", "")]
		public unsafe OutlineAdapter (global::Android.Views.LayoutInflater p0, global::Artifex.MuPdf.OutlineItem[] p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (OutlineAdapter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Landroid/view/LayoutInflater;[Lcom/artifex/mupdfdemo/OutlineItem;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/view/LayoutInflater;[Lcom/artifex/mupdfdemo/OutlineItem;)V", __args);
					return;
				}

				if (id_ctor_Landroid_view_LayoutInflater_arrayLcom_artifex_mupdfdemo_OutlineItem_ == IntPtr.Zero)
					id_ctor_Landroid_view_LayoutInflater_arrayLcom_artifex_mupdfdemo_OutlineItem_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/view/LayoutInflater;[Lcom/artifex/mupdfdemo/OutlineItem;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_view_LayoutInflater_arrayLcom_artifex_mupdfdemo_OutlineItem_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_view_LayoutInflater_arrayLcom_artifex_mupdfdemo_OutlineItem_, __args);
			} finally {
				if (p1 != null) {
...
#pragma warning disable 0169
		...
		{
			global::Artifex.MuPdf.OutlineAdapter __this = global::Java.Lang.Object.GetObject<global::Artifex.MuPdf.OutlineAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Count;
		}
#pragma warning restore 0169
		...
		public override unsafe int Count {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']/method[@name='getCount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']/method[@name='getItem' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']/method[@name='getItemId' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.artifex.mupdfdemo']/class[@name='OutlineAdapter']/method[@name='getView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"
